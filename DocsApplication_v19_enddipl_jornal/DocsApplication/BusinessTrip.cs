...
{
    public partial class BusinessTrip : MetroFramework.Forms.MetroForm
    {
        SqlConnection connection = new SqlConnection(@"Data Source=HOME\SQLEXPRESS;Initial Catalog=Docs;Integrated Security=True");
        private readonly string TemplateFileName = @"D:\Docs\Шаблон\LAW47274_13_20170024_171405.doc";
        public BusinessTrip()
        {
            InitializeComponent();
        }
        ...
        private void metroButton1_Click(object sender, EventArgs e)
        {
            ...
            string file = @"D:\Docs\Командировка\" + namedoc + ".doc";
            ...
            if (metroTextBox3.Text != "")
            {
                ...
                xp.Parameters.AddWithValue("@id_k", "6");
        ...
        private void metroTextBox1_KeyUp_1(object sender, KeyEventArgs e)
        {
            connection.Open();
