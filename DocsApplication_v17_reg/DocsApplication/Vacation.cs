...
{
    public partial class Vacation : MetroFramework.Forms.MetroForm
    {
        public Vacation()
        {
            InitializeComponent();
        ...
        private readonly string TemplateFileName = @"D:\Docs\Шаблон\LAW47274_8_20170024_171405.doc";
        ...
        private void metroButton1_Click(object sender, EventArgs e)
        {
            ...
            string file = @"D:\Docs\Отпуск\" + namedoc + ".doc";
            ...
            if (metroTextBox3.Text != "")
            {
                try
                {
                    ...
                    xp.Parameters.AddWithValue("@id_k", "4");
