...
{
    public partial class Fire : MetroFramework.Forms.MetroForm
    {
        SqlConnection connection = new SqlConnection(@"Data Source=HOME\SQLEXPRESS;Initial Catalog=Docs;Integrated Security=True");
        private readonly string TemplateFileName = @"D:\Docs\Шаблон\LAW47274_11_20170024_171405.doc";
        public Fire()
        {
            InitializeComponent();
        }
        ...
        private void metroButton1_Click(object sender, EventArgs e)
        {
            ...
            string file = @"D:\Docs\Увольнение\" + namedoc + ".doc";
            ...
            if (metroTextBox3.Text != "")
            {
                try
                {
                    ...
                    xp.Parameters.AddWithValue("@id_k", "5");
                ...
                try
                {
                    ...
                    ReplaceWordStub("{date3}", dat, wordDocument);
