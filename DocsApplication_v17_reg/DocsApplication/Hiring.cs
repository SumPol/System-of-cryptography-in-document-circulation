...
{
    public partial class Hiring : MetroFramework.Forms.MetroForm
    {
        public Hiring()
        {
            InitializeComponent();
        ...
        private readonly string TemplateFileName = @"D:\Docs\Шаблон\LAW47274_0_20170024_171405.doc";
        ...
        private void metroButton1_Click(object sender, EventArgs e)
        {
            ...
            string file = @"D:\Docs\Приём\" + namedoc + ".doc";
            ...
            if (metroTextBox3.Text != "")
            {
                try
                {
                    ...
                    xp.Parameters.AddWithValue("@id_k", "1");
